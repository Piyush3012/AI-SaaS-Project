...
//this is axios baseURL to make the api calls from frontend to the backend.
...
const BlogTitles = () => {
  ...
  const onSubmitHandler=async(e)=>{
    ...
    try {
      setLoading(true);
      const prompt = `Write the blog title for the keyword ${input} in the category ${selectedCategory} `
